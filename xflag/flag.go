...
func init() {
	...
	// nfs := xflag.NewFlagSet(procName, xflag.ExitOnError)
	flagset = &FlagSet{
...
// Flag ...
type (
	// Flag defines application xflag.
	Flag interface {
		Apply(*FlagSet)
	}
...
// Lookup lookup xflag value by name
// priority: xflag > default > env
...
// BoolE parses bool xflag of the flagset with error returned.
func BoolE(name string) (bool, error) { return flagset.BoolE(name) }

// BoolE parses bool xflag of provided flagset with error returned.
func (fs *FlagSet) BoolE(name string) (bool, error) {
	...
	return false, fmt.Errorf("undefined xflag name: %s", name)
}

// Bool parses bool xflag of the flagset.
func Bool(name string) bool { return flagset.Bool(name) }

// Bool parses bool xflag of provided flagset.
func (fs *FlagSet) Bool(name string) bool {
	ret, _ := fs.BoolE(name)
	return ret
}

// StringE parses string xflag of the flagset with error returned.
func StringE(name string) (string, error) { return flagset.StringE(name) }

// StringE parses string xflag of provided flagset with error returned.
func (fs *FlagSet) StringE(name string) (string, error) {
	...
	return "", fmt.Errorf("undefined xflag name: %s", name)
}

// String parses string xflag of the flagset.
func String(name string) string { return flagset.String(name) }

// String parses string xflag of provided flagset.
func (fs *FlagSet) String(name string) string {
	ret, _ := fs.StringE(name)
	return ret
}

// IntE parses int xflag of the flagset with error returned.
func IntE(name string) (int64, error) { return flagset.IntE(name) }

// IntE parses int xflag of provided flagset with error returned.
func (fs *FlagSet) IntE(name string) (int64, error) {
	...
	return 0, fmt.Errorf("undefined xflag name: %s", name)
}

// Int parses int xflag of the flagset.
func Int(name string) int64 { return flagset.Int(name) }

// Int parses int xflag of provided flagset.
func (fs *FlagSet) Int(name string) int64 {
	ret, _ := fs.IntE(name)
	return ret
}

// UintE parses int xflag of the flagset with error returned.
func UintE(name string) (uint64, error) { return flagset.UintE(name) }

// UintE parses int xflag of provided flagset with error returned.
...
// Uint parses int xflag of the flagset.
func Uint(name string) uint64 { return flagset.Uint(name) }

// Uint parses int xflag of provided flagset.
func (fs *FlagSet) Uint(name string) uint64 {
	ret, _ := fs.UintE(name)
	return ret
}

// Float64E parses int xflag of the flagset with error returned.
func Float64E(name string) (float64, error) { return flagset.Float64E(name) }

// Float64E parses int xflag of provided flagset with error returned.
func (fs *FlagSet) Float64E(name string) (float64, error) {
	...
	return 0.0, fmt.Errorf("undefined xflag name: %s", name)
}

// Float64 parses int xflag of the flagset.
func Float64(name string) float64 { return flagset.Float64(name) }

// Float64 parses int xflag of provided flagset.
func (fs *FlagSet) Float64(name string) float64 {
	ret, _ := fs.Float64E(name)
	return ret
}

// BoolFlag is a bool xflag implements of Flag interface.
...
// StringFlag is a string xflag implements of Flag interface.
...
// IntFlag is an int xflag implements of Flag interface.
type IntFlag struct {
	Name     string
	Usage    string
	Default  int
...
// UintFlag is an uint xflag implements of Flag interface.
...
// Float64Flag is a float xflag implements of Flag interface.
